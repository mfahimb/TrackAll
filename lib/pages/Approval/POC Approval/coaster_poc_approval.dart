...
// ─────────────────────────────────────────────
// PAGE  — 2nd approval stage (Coaster)
// ─────────────────────────────────────────────
class CoasterPocApprovalPage extends StatefulWidget {
  const CoasterPocApprovalPage({super.key});

  @override
  State<CoasterPocApprovalPage> createState() =>
      _CoasterPocApprovalPageState();
}

class _CoasterPocApprovalPageState extends State<CoasterPocApprovalPage>
    with SingleTickerProviderStateMixin {
  static const _stage = ApprovalStage.coaster;
  ...
  bool _loadingItems    = false;   // spinner for item dropdown
  bool _loadingCostNos  = false;   // spinner for cost no dropdown
  ...
  Future<void> _init() async {
    ...
    // Only load buyers — items & costNos cascade from buyer selection
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Row(children: [
              ...
              Text("Filters",
                  style: TextStyle(
                      color: _filtersExpanded ? _textPri : _textSec,
                      fontSize: 13,
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: _borderLight, width: 1.5),
                  boxShadow: [BoxShadow(
