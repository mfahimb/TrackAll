...
class IEPocApprovalPage extends StatefulWidget {
  const IEPocApprovalPage({super.key});

  @override
  State<IEPocApprovalPage> createState() => _IEPocApprovalPageState();
}

class _IEPocApprovalPageState extends State<IEPocApprovalPage>
    with SingleTickerProviderStateMixin {
  static const _stage = ApprovalStage.ie;
  ...
  Future<void> _init() async {
    ...
    // ✅ userId is the correct key — staffCode stores "Login Success" (bug)
